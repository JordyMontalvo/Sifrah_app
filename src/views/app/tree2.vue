<template>
        ...
        <div class="cards-container">
          <div class="card" :class="{ 'mobile': isMobile, 'mobile-small': isMobileSmall }" @click="selectMode('red')">
            ...
            <div class="card-icon">
              ...
              <img src="@/assets/img/red-network-new.svg" alt="Red" :class="{ 'mobile': isMobile, 'mobile-small': isMobileSmall }" style="width: 140px; height: 140px; object-fit: contain;">
            </div>
          </div>
          <div class="card" :class="{ 'mobile': isMobile, 'mobile-small': isMobileSmall }" @click="selectMode('frontales')">
            ...
            <div class="card-icon">
              ...
              <img src="@/assets/img/frontales-icon.svg" alt="Frontales" :class="{ 'mobile': isMobile, 'mobile-small': isMobileSmall }" style="width: 140px; height: 140px; object-fit: contain;">
            </div>
          </div>
          <div class="card" :class="{ 'mobile': isMobile, 'mobile-small': isMobileSmall }" @click="selectMode('niveles')">
            ...
            <div class="card-icon">
              ...
              <img src="@/assets/img/niveles-icon.svg" alt="Niveles" :class="{ 'mobile': isMobile, 'mobile-small': isMobileSmall }" style="width: 140px; height: 140px; object-fit: contain;">
            </div>
          </div>
          <div class="card" :class="{ 'mobile': isMobile, 'mobile-small': isMobileSmall }" @click="selectMode('actividad')">
            ...
            <div class="card-icon">
              ...
              <img src="@/assets/img/actividad-icon.svg" alt="Actividad" :class="{ 'mobile': isMobile, 'mobile-small': isMobileSmall }" style="width: 140px; height: 140px; object-fit: contain;">
            </div>
          </div>
        </div>
  ...
  .btn-green {
    background: linear-gradient(135deg,rgb(10, 116, 35),rgb(14, 121, 37));
    color: white;
  ...
  .btn-orange {
    background: linear-gradient(135deg, #e67e00, #f39c12);
    color: white;
    font-size: 24px;
    padding: 28px 56px;
  ...
  .btn-orange:hover {
    ...
    transform: translateY(-3px);
    box-shadow: 0 8px 30px rgba(230, 126, 0, 0.4);
    border-color: #d35400;
  }
