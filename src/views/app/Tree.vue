...
<div v-if="!loading" class="hierarchy-summary">
        ...
        <div class="summary-cards">
          <div class="summary-card">
            <div class="card-icon">
              <svg class="card-icon-svg" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <circle cx="18" cy="18" r="18" fill="#e91e63"/>
                <path d="M18 19.1C20.5 19.1 22.5 17 22.5 14.5S20.5 10 18 10s-4.5 2-4.5 4.5S15.5 19.1 18 19.1Z" fill="#fff"/>
                <path d="M23.7 17.9A3.4 3.4 0 1 0 23.7 11.1a3.4 3.4 0 0 0 0 6.8Z" fill="#fff"/>
                <path d="M12.3 17.9A3.4 3.4 0 1 0 12.3 11.1a3.4 3.4 0 0 0 0 6.8Z" fill="#fff"/>
                <path d="M18 20.2c4.2 0 5.3 3.7 5.6 5.7.1.6-.4 1.1-1 1.1H13.5c-.6 0-1.1-.5-1-1.1.3-2 1.4-5.7 5.5-5.7Z" fill="#fff"/>
                <path d="M24.3 24.7h2.6c.7 0 1.2-.6 1-.1.2-1.7-.9-4.4-3.6-4.4-.9 0-1.7.3-2.3.8 1.6 1.1 2.5 3 2.9 4.7Zm-9.6-4.7c-.6-.6-1.5-.9-2.4-.9-2.8 0-3.9 2.8-4.3 4.4-.2.7.3 1.2 1 1.2h2.6c.5-1.7 1.4-3.6 3.1-4.7Z" fill="#fff"/>
              </svg>
            </div>
          ...
          <div class="summary-card">
            <div class="card-icon">
              <svg class="card-icon-svg" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <circle cx="18" cy="18" r="18" fill="#e91e63"/>
                <path d="M14.2 17.8c2.1 0 3.8-1.7 3.8-3.8S16.3 10.2 14.2 10.2 10.4 12 10.4 14s1.7 3.8 3.8 3.8Z" fill="#fff"/>
                <path d="M14.2 19.2c-3.6 0-6.2 2.2-6.6 5.3-.1.6.3 1.1.9 1.1h11.4c.6 0 1-.5.9-1.1-.4-3.1-3-5.3-6.6-5.3Z" fill="#fff"/>
                <path d="M24.2 12.2v2.6h-2.6v2.2h2.6v2.6h2.2v-2.6h2.6v-2.2h-2.6v-2.6h-2.2Z" fill="#fff"/>
              </svg>
            </div>
            <div class="card-content">
          ...
          <div class="summary-card">
            <div class="card-icon">
              <svg class="card-icon-svg" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <circle cx="18" cy="18" r="18" fill="#e91e63"/>
                <rect x="14.5" y="7.5" width="7" height="5.2" rx="1.4" fill="#fff"/>
                <rect x="8.2" y="15.6" width="7" height="5.2" rx="1.4" fill="#fff"/>
                <rect x="20.8" y="15.6" width="7" height="5.2" rx="1.4" fill="#fff"/>
                <rect x="8.2" y="23.6" width="7" height="5.2" rx="1.4" fill="#fff"/>
                <rect x="20.8" y="23.6" width="7" height="5.2" rx="1.4" fill="#fff"/>
                <path d="M18 12.7v2.9M11.7 20.8v2.8M24.3 20.8v2.8M18 15.6H11.7M18 15.6h6.3" stroke="#fff" stroke-width="1.6" stroke-linecap="round"/>
              </svg>
            </div>
            <div class="card-content">
          ...
          <div class="summary-card">
            <div class="card-icon">
              <svg class="card-icon-svg" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <circle cx="18" cy="18" r="18" fill="#e91e63"/>
                <path d="M18 8.2 20.4 15h7.4l-6 4.4 2.3 6.8L18 22l-6.1 4.2 2.3-6.8-6-4.4h7.4L18 8.2Z" fill="#fff"/>
              </svg>
            </div>
            <div class="card-content">
